...
if(isset($_POST['update_product'])){
   ...
   if(empty($product_name) || empty($product_price) || empty($product_description) ){
      ...
      $update_data = "UPDATE products SET name='$product_name', image='$product_image' , description='$product_description', quantity='$product_quantity' , price='$product_price'  WHERE product_id = '$id'";
...
<div class="admin-product-form-container centered">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="text" class="box" name="product_quantity" value="<?php echo $row['quantity']; ?>"placeholder="enter product description">
