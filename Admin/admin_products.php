...
if(isset($_POST['add_product'])){
   ...
   $image_folder = 'uploaded_img/'.$image;
      ...
      $add_product_query = mysqli_query($conn, "INSERT INTO `products`(name, image, description, price) VALUES('$name', '$image', '$description', '$price')") or die('query failed');
...
if(isset($_POST['update_product'])){
   ...
   $update_description = $_FILES['update_quantity']['quantity'];
...
<section class="add-products">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <textarea rows="4" cols="80" class="box" name="description" placeholder="enter product description"></textarea>
...
<section class="edit-product-form">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="text" name="update_description" value="<?php echo $fetch_update['quantity']; ?>" class="box" required placeholder="enter product quantity">
